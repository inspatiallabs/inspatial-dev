/**
 * # Types for Interact - (InSpatial State x Trigger)
 *
 ...
 */
export interface StateQLInstanceType<T extends object = {}>
  extends StateInstanceType<T> {
 ...
 */
export interface DerivedStateOptionsType<T extends object>
  extends StateOptionsType {
