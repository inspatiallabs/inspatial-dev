/**
 * Signal Lite Deno Example - DOM Integration
 * 
 * This example demonstrates the signal-lite reactive system working
 * with vanilla DOM APIs and event listeners in the Deno runtime.
 */
...
function setupTextDemo(): void {
  const text = createSignal("Hello Deno");
...
// ==========================================
// Deno Runtime Info Demo
// ==========================================

function setupDenoRuntimeDemo(): void {
  // DOM element references
  const runtimeInfo = document.getElementById("runtime-info")!;
  const denoVersion = document.getElementById("deno-version")!;
  const tsSupport = document.getElementById("ts-support")!;
  const serverType = document.getElementById("server-type")!;

  // Update runtime information
  runtimeInfo.textContent = "Deno 🦕";
  
  // Get Deno version information
  try {
    denoVersion.textContent = Deno.version.deno;
  } catch {
    denoVersion.textContent = "Unknown";
  }

  // Update other info
  tsSupport.textContent = "✅ Native TypeScript support";
  serverType.textContent = "Built-in HTTP server with file watching";

  console.log("✅ Deno runtime info initialized");
}
...
function demonstrateAdvancedSignalOperations(): void {
  console.log("\n🔬 Advanced Signal Operations Demo (Deno Runtime)");
  ...
  // Deno-specific logging
  console.log("\n🦕 Deno Runtime Features:");
  console.log("Built-in TypeScript:", "✅");
...
function initializeApp(): void {
  console.log("🦕 Initializing Signal Lite Deno Example App");
