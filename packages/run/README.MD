...
## 🦵 InSpatial Run (🟡 Preview)
InSpatial Run is a universal development framework for building cross-platform and spatial applications.


## 📦 Install InSpatial Run


```bash
deno install jsr:@inspatial/run
```
...
To begin your journey with InSpatial Core, visit our comprehensive documentation at [inspatial.run](https://www.inspatial.run).
...
<div align="center">
  <strong>Ready to supercharge your development?</strong>
  <br>
  <a href="https://www.inspatial.run">Get Started with InSpatial Run</a>
</div>
