...
export class ParameterValidationErrorClass extends TriggerErrorClass {
  constructor(message: string, paramName: string, receivedValue: any) {
    super(message, ErrorCodeEnum.INVALID_PARAMETER, LogSeverityEnum.WARNING, {
      paramName,
      receivedValue,
    });
...
export class ErrorLoggerClass {
  ...
  public error(
    ...
    const error = new TriggerErrorClass(
      message,
      code,
      LogSeverityEnum.ERROR,
      context
