 ...
 * InSpatial Type
 * 
 * A universal runtime type validation library for TypeScript and JavaScript,
 * providing a comprehensive system for validating data at runtime with
 * compile-time type inference.
 * 
 * This library builds on the foundations of ArkType to provide a robust
 * validation system tailored specifically for spatial computing and general
 * application development needs.
 * 
 * Core features include:
 * - Concise and expressive type definitions
 * - Fast runtime validation
 * - Detailed error messages
 * - TypeScript integration with full type inference
 * - Extension system for custom validators
 * - Pipeline system for data transformation
 * - Schema registry for sharing types
