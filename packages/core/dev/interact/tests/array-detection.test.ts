...
import { createStore, unwrap } from "../signal/src/index.ts";
...
console.log("- prototype chain:", Object.getPrototypeOf(storeArray) === Array.prototype);
...
const [todos, setTodos] = createStore([{ id: 1, done: true }, { id: 2, done: false }]);
...
console.log("- Array.isArray from second failing test:", Array.isArray(nested.todos));
