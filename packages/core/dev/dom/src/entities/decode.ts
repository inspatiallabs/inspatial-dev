...
import { replaceCodePoint, fromCodePoint } from "./decode-codepoint.ts";
...
// Re-export for use in the html parser
export { htmlDecodeTree } from "./generated/decode-data-html.ts";
export { xmlDecodeTree } from "./generated/decode-data-xml.ts";
