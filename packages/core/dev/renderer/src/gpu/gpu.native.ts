 ...
 * 
 * WHY: WebGPU can only be used in a web browser.
 * This file is an upstream version of https://github.com/emscripten-core/emscripten/blob/main/src/lib/libwebgpu.js
 * It is used to create a native WebGPU implementation for Node.js.
 */
