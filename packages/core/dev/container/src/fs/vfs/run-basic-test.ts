...
async function testMemoryFile() {
  console.log("Testing MemoryFile...");
  ...
  console.log("✅ MemoryFile tests passed");
}

// Test the MemoryDirectory class
async function testMemoryDirectory() {
  console.log("Testing MemoryDirectory...");
  ...
  console.log("✅ MemoryDirectory tests passed");
}

// Test the MemorySymlink class
async function testMemorySymlink() {
  console.log("Testing MemorySymlink...");
  ...
  console.log("✅ MemorySymlink tests passed");
}

// Test the MemoryFileHandle class
async function testMemoryFileHandle() {
  console.log("Testing MemoryFileHandle...");
  ...
  console.log("✅ MemoryFileHandle tests passed");
}

// Run all tests
async function runAllTests() {
  console.log("=== Running Memory FS Tests ===");
  
  try {
    await testMemoryFile();
    await testMemoryDirectory();
    await testMemorySymlink();
    await testMemoryFileHandle();
